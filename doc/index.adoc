...
_You need the VMWare plugin from https://www.vagrantup.com/vmware/_
...
The *VMWare* version does not provide a correct port and IP forwarding.
Therefore, the correct IP can be determined as follows
